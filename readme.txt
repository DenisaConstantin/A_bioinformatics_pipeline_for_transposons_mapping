...
1_genome.sh
This script processes the genomes for the following scripts. It must be run without D. melanogaster in the folder. Subsequently, it is added and the following command is run:
